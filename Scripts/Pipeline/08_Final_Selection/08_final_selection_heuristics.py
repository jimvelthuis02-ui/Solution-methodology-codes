...
def _load_stage9_module() -> Any:
    ...
    spec = importlib.util.spec_from_file_location("stage9_for_stage8_variants", stage9_path)
...
def _stage8_variant_dir(variant: dict[str, object]) -> Path:
    ...
    return VARIANTS_ROOT / str(variant["label"]) / folder


def _generate_stage8_variants() -> None:
    ...
    try:
        for variant in VARIANTS:
            ...
            stage9._run_stage8_variant(variant)
